...
public class MealTestData {
    ...
    public static final Set<Meal> meals = Set.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1);

    public static final Set<Meal> adminMeals = Set.of(adminMeal1, adminMeal2);
